...
export default {
  data() {
    return {
      ...
      names: ['Oliver', 'Jake', 'Noah', 'James', 'Jack', 'Connor', 'Liam', 'John', 'Harry', 'Callum', 'Mason', 'Robert', 'Jacob', 'Michael', 'Charlie', 'Kyle', 'William', 'Thomas', 'Joe', 'Ethan', 'David', 'George', 'Reece', 'Oscar', 'Rhys', 'Alexander', 'Joseph', 'James', 'Charles', 'Damian', 'Daniel', 'Amelia', 'Margaret', 'Emma', 'Mary', 'Olivia', 'Samantha', 'Patricia', 'Isla', 'Bethany'],
